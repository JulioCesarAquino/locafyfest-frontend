...
import { getOrders, type OrderAPI } from '@/services/orders';
import { getClients } from '@/services/clients';
import { getProducts, type ProductAPI } from '@/services/products';
...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: React.ElementType }> = {
  ...
  returned:  { label: 'Devolvido',  color: 'bg-green-500/15 text-green-600 border-green-500/30',    icon: RotateCcw },
