                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground">até {format(new Date(order.endDate), 'dd/MM/yyyy', { locale: ptBR })}</div>
                      </div>
                    </TableCell>
                      ...
                      return (
                        <div key={index} className="flex items-center justify-between text-sm">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="font-medium">R$ {(variation?.price || 0) * item.quantity}</span>
                            <Button
                              variant="ghost"
                              size="sm"
